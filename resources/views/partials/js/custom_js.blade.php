...
function getLGA(state_id){
    ...
    $.ajax({
        ...
        success: function (resp) {
            updateDropdown(lga, resp);  // Using the helper function to update the LGA dropdown
        }
    });
}
...
function getState(nal_id){
    ...
    var state = $('#state_id');  // Corrected the selector

    $.ajax({
        dataType: 'json',
        url: url,
        success: function (resp) {
            updateDropdown(state, resp);  // Using the helper function to update the State dropdown
        }
    });
}
