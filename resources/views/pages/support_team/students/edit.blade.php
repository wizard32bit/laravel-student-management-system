                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->email  }}" type="email" name="email" class="form-control" placeholder="your@email.com" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label>Phone:</label>
                                <input value="{{ $sr->user->phone  }}" type="text" name="phone" class="form-control" placeholder="+1234567890" >
                            </div>
                        </div>
