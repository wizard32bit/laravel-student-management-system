...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" action="{{ route('users.update', Qs::hash($user->id)) }}" data-foc>
                @csrf @method('PUT')
                <h6>Personal Data</h6>
                <fieldset>
                    <div class="row">
                        <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select disabled="disabled" class="form-control select" id="user_type">
                                    <option value="">{{ ucwords($user->user_type) }}</option>
                                </select>
                            </div>
                        </div>
