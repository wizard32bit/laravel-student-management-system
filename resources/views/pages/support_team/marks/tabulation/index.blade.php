                ...
                <table class="table table-responsive table-striped">
                    ...
                    @foreach($students as $s)
                        <tr>
                            ...
                            <td style="color: darkred">{{ DB::table('exam_records')->where('student_id', $s->user_id)->value('total') ?: '-' }}</td>
                            <td style="color: darkblue">{{ DB::table('exam_records')->where('student_id', $s->user_id)->value('ave') }}</td>
                            <td style="color: darkgreen">{!! Mk::getSuffix(DB::table('exam_records')->where('student_id', $s->user_id)->value('pos')) ?: '-' !!}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
